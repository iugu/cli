...
npm shim for the [iugu CLI](https://github.com/iugu/cli): `postinstall` downloads the
...
Prefer Homebrew (`brew install iugu/tap/iugu`) or `install.sh` for a system-wide binary.
